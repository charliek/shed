...
// same error.
var ErrLegacyMetadata = errors.New("metadata is from an older shed release; remove the instance directory under {firecracker.instance_dir}/<name>/, the images_dir blob store, and recreate the shed")
